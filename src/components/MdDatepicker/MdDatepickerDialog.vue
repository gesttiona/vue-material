  ...
  <md-popover :md-settings="popperSettings" md-active>
    ...
    >
      <div class="md-datepicker-dialog" :class="[$mdActiveTheme]">
        <div v-if="mdShowHeader" class="md-datepicker-header">
          <span
            ...
            <transition name="md-datepicker-view">
              ...
              >
                ...
                >
                  ...
                  >{{ currentMonthName }} {{ currentYear }}</md-button>

                  <div class="md-datepicker-week">
                    <template v-for="(day, index) in locale.shorterDays">
                      <span :key="index" v-if="index >= firstDayOfAWeek">{{ day }}</span>
                    </template>
                    <template v-for="(day, index) in locale.shorterDays">
                      <span :key="index" v-if="index < firstDayOfAWeek">{{ day }}</span>
                    </template>
...
.md-datepicker-dialog {
  ...
  flex-shrink: 0;
  transition: opacity 0.2s $md-transition-stand-timing,
    transform 0.35s $md-transition-stand-timing;
